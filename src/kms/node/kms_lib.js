...
module.exports.cryptobox_encrypt = function (msg, their_pk, my_sk) {
  ...
  const ret = wasm.cryptobox_encrypt(
    ptr0,
    len0,
    their_pk.__wbg_ptr,
    my_sk.__wbg_ptr,
 ...
 */
module.exports.make_reencryption_req = function (
  client,
  signature,
  enc_pk,
  fhe_type,
 ...
 * @returns {number}
 */
module.exports.process_reencryption_resp = function (
  client,
  request,
  agg_resp,
  agg_resp_ids,
  ...
  try {
    ...
    wasm.process_reencryption_resp(
      retptr,
      client.__wbg_ptr,
      ptr0,
      ptr1,
...
const Eip712DomainMsgFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
class Eip712DomainMsg {
  ...
  set verifying_contract(arg0) {
    ...
    const len0 = WASM_VECTOR_LEN;
    wasm.__wbg_set_eip712domainmsg_verifying_contract(
      this.__wbg_ptr,
      ptr0,
      len0,
    );
...
const PrivateEncKeyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
...
const PrivateSigKeyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
...
const PublicEncKeyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
...
const PublicSigKeyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
...
const ReencryptionRequestFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
...
const ReencryptionRequestPayloadFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
...
class ReencryptionRequestPayload {
   ...
   */
  get version() {
    const ret = wasm.__wbg_get_reencryptionrequestpayload_version(
      this.__wbg_ptr,
    );
    return ret >>> 0;
  }
   ...
   */
  get servers_needed() {
    const ret = wasm.__wbg_get_reencryptionrequestpayload_servers_needed(
      this.__wbg_ptr,
    );
    return ret >>> 0;
  }
  ...
  set servers_needed(arg0) {
    wasm.__wbg_set_reencryptionrequestpayload_servers_needed(
      this.__wbg_ptr,
      arg0,
    );
  }
  ...
  get randomness() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.__wbg_get_reencryptionrequestpayload_randomness(
        retptr,
        this.__wbg_ptr,
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
   ...
   */
  get fhe_type() {
    const ret = wasm.__wbg_get_reencryptionrequestpayload_fhe_type(
      this.__wbg_ptr,
    );
    return ret;
  }
   ...
   */
  get key_id() {
    const ret = wasm.__wbg_get_reencryptionrequestpayload_key_id(
      this.__wbg_ptr,
    );
    return ret === 0 ? undefined : RequestId.__wrap(ret);
  }
  ...
  get ciphertext() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.__wbg_get_reencryptionrequestpayload_ciphertext(
        retptr,
        this.__wbg_ptr,
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  set ciphertext(arg0) {
    var ptr0 = isLikeNone(arg0)
      ? 0
      : passArray8ToWasm0(arg0, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.__wbg_set_reencryptionrequestpayload_ciphertext(
      this.__wbg_ptr,
      ptr0,
      len0,
    );
  ...
  get ciphertext_digest() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.__wbg_get_reencryptionrequestpayload_ciphertext_digest(
        retptr,
        this.__wbg_ptr,
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
...
const ReencryptionResponseFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
...
class ReencryptionResponse {
   ...
   */
  get servers_needed() {
    const ret = wasm.__wbg_get_reencryptionresponse_servers_needed(
      this.__wbg_ptr,
    );
    return ret >>> 0;
  }
...
module.exports.__wbg_newwithbyteoffsetandlength_aa4a17c33a06e5cb = function (
  arg0,
  arg1,
  arg2,
) {
